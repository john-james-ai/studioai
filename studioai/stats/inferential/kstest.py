...
# Modified   : Wednesday August 23rd 2023 09:55:28 am                                              #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from studioai.data.distribution import RVSDistribution
...
class KSTestResult(StatTestResult):
    ...
    @inject
    def __post_init__(
        self, canvas: Canvas = Provide[VisualContainer.canvas]

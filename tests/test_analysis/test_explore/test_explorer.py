...
# Version    : 0.1.0                                                                               #
# Python     : 3.10.12                                                                             #
# Filename   : /tests/test_analysis/test_explore/test_explorer.py                                  #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
class TestDataset:  # pragma: no cover
    ...
    # ============================================================================================ #
    def test_shape(self, credit, caplog):
        start = datetime.now()
        logger.info(
            "\n\nStarted {} {} at {} on {}".format(
                self.__class__.__name__,
    ...
    def test_stats(self, credit, caplog):
        ...
        # ---------------------------------------------------------------------------------------- #
        ds = CreditScoreExplorer(df=credit)
        result = ds.stats.cramersv(a="Education", b="Credit Rating")
